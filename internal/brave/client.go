...
func (c *Client) Search(ctx context.Context, request SearchRequest) (SearchResponse, error) {
	...
	values.Set("country", c.config.Search.Country)
	values.Set("search_lang", c.config.Search.SearchLang)
	values.Set("ui_lang", c.config.Search.UILang)
	values.Set("safesearch", c.config.Search.Safesearch)
	values.Set("spellcheck", strconv.FormatBool(c.config.Search.Spellcheck))
