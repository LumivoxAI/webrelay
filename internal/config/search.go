...
func DefaultSearchConfig() SearchConfig {
	return SearchConfig{
		DefaultLimit: 10,
		MaxLimit:     20,
		Providers:    []string{"exa", "tinyfish", "tavily", "firecrawl", "brave"},
	}
}
...
func (c SearchConfig) Validate() error {
	...
	return validateProviderOrder("search.providers", c.Providers, map[string]bool{"exa": true, "tinyfish": true, "tavily": true, "firecrawl": true, "brave": true})
}
